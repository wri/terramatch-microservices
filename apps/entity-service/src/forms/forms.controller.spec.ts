...
describe("FormsController", () => {
  ...
  describe("delete", () => {
    ...
    it("Destroys the form and all questions", async () => {
      ...
      const sections = await FormSectionFactory.forForm(form).createMany(2);
      const questions = [
        ...(await FormQuestionFactory.forSection(sections[0]).createMany(3)),
        ...(await FormQuestionFactory.forSection(sections[1]).createMany(2))
      ];
      service.findOne.mockResolvedValue(form);
